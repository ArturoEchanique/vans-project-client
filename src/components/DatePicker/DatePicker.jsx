...
const DatePicker = ({ handleDatesChange, reservedDays }) => {
    ...
    console.log("reservedDays are", reservedDays)

    const isDayBlocked = (day) => {
        const today = new Date()
        const tomorrow = new Date(today)
        tomorrow.setDate(tomorrow.getDate() + 1)
        const unavailableDays = reservedDays ? reservedDays : [today, tomorrow]
